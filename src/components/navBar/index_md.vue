<template>
  <div
    ...
    <div class="relative">
      <button>
        <font-awesome-icon icon="fa-solid fa-ellipsis-vertical" class="text-xl" @click="store.toggleEllipsis" />
      </button>
        ...
        <div class="py-1">
          <div id="tool" class="flex items-center capitalize">
            ...
            <a href="https://github.com/maple24/vite-admin">
              <font-awesome-icon icon="fa-brands fa-github" class="text-lg pt-1 mr-4" />
            </a>
