  ...
  <div id="sidebar" class="dark:bg-gray-700 dark:text-white border-2">
    <ul class="py-5 flex flex-col">
      <li class="siderbar-icon">
        <RouterLink to="/"><font-awesome-icon icon="fa-solid fa-dashboard" class="text-5xl text-green-300" />
        </RouterLink>
      </li>
      <li class="siderbar-icon">
        <RouterLink to="/RQM/search"><font-awesome-icon icon="fa-brands fa-twitter" class="text-5xl text-blue-400" />
        </RouterLink>
      </li>
      <li class="siderbar-icon">
        <RouterLink to="/RQM/upload"><font-awesome-icon icon="fa-solid fa-download" class="text-5xl" /></RouterLink>
      </li>
      <li class="siderbar-icon">
